...
function site_files() {
  ...
  if(strstr($_SERVER['SERVER_NAME'], 'wordpress-boilerplate.local')){
    ...
    wp_enqueue_script('main-site-js', get_theme_file_uri('/bundled-assets/scripts.dc01ead4b27c51fa1d80.js'), NULL, '1.0', true);
    wp_enqueue_style('our-main-styles', get_theme_file_uri('/bundled-assets/styles.dc01ead4b27c51fa1d80.css'));
  }
}

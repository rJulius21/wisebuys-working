...
function site_files() {
  ...
  if(strstr($_SERVER['SERVER_NAME'], 'wordpress-boilerplate.local')){
    ...
    wp_enqueue_script('main-site-js', get_theme_file_uri('/bundled-assets/scripts.08565573e5f846b8360e.js'), NULL, '1.0', true);
    wp_enqueue_style('our-main-styles', get_theme_file_uri('/bundled-assets/styles.08565573e5f846b8360e.css'));
  }
}
